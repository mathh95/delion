...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Set-2019 às 20:35
...
CREATE TABLE `cardapio` (
  ...
  `adicional` mediumtext COLLATE utf8_bin,
...
(103, 'Zé da esquina', 45998081179, 'Rua Golfinho 1463', '2310', 'bairro teste', 'fundos teste a');
...
(4, 'df1wu1p1fs8', 13, 13, '9.50', '2020-02-20', 4),
(5, 'df1wvn2p118', 10, 10, '15.00', '2020-05-16', 1),
(6, 'df1wvwu189', 5, 5, '7.50', '2019-09-13', 1);
...
(84, 103, '2019-09-12 08:47:38', 'Cartão de Crédito', '33.50', 1, NULL, NULL);
...
(12, 'Matheus Teste aaa', 'matheus', '45339359513f09155110f63f7ca91c3e', '', 0, 0, '[\"usuario\",\"empresa\",\"banner\",\"imagem\",\"evento\",\"categoria\",\"cardapio\",\"cliente\",\"pedido\",\"avaliacao\",\"combo\",\"adicional\",\"pedidoWpp\"]'),
...
--
ALTER TABLE `cliente_wpp`
  MODIFY `cod_cliente_wpp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
...
--
ALTER TABLE `item_pedido_wpp`
  MODIFY `cod_item_pedido_wpp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=268;
...
--
ALTER TABLE `pedido_wpp`
  MODIFY `cod_pedido_wpp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
