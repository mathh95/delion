...
$db->sql("SELECT * FROM promocao WHERE cod_promocao = '".$_GET['codigo'] . "'");
...
function envia_permissao(cod_promocao){
   if (confirm("Você tem certeza que deseja realizar essa operação?")) 
   {
		var url;
		url = "cadastro_permissao_bd.php?cod_promocao=" + cod_promocao;
...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<? 
                  ...
                  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      ...
                      <form name="formulario" id="formulario" action="../promocao/alteracao_bd.php" method="post" enctype="multipart/form-data">
                      <fieldset id="set1">
                      <table width="95%" border="0" align="center" cellpadding="3" cellspacing="0">
                            ...
                            <tr> 
                              <td bgcolor="#D8E3EB"> <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                  <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td><b>
                                        ...
                                        <textarea name="descricao" cols="60" rows="6" id="descricao"><? echo $valor['descricao'];   ?></textarea>
                                      </b></td>
                                    </tr>  
                                  ...
                                  <tr>
									...
									<?php                                        
                                          //executa query
                                          $db->sql("SELECT * FROM foto where codigo = '".$_GET['codigo']."' and tabela LIKE 'promocao' order by cod_foto ");
                                          //echo $db;
										  $i = 0;      
                            ...
                            <tr> 
                              <td> <div align="left"> 
                                  <input type="hidden" name="cod_promocao" value="<? echo $_GET['codigo']; ?>" >
              ...
              <tr> 
                <td colspan="2"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="48"> <div align="left"><a href="../promocao/consulta.php"><img src="../img/btn_voltar.jpg" width="47" height="17" border="0"></a></div></td>
