<?php
  ...
  include("../biblioteca/online.php");
	  ...
	  //Prepara o sql	
		if ($_REQUEST['nome'] != '') {
			$sql = "SELECT cod_faq, pergunta FROM faq where pergunta like '%".$_REQUEST['nome']."%' order by pergunta";
		} else {
			$sql = "SELECT cod_faq, pergunta FROM faq order by pergunta";	  
		}
	  ...
	  $p = new paginacao($db,$sql,15,10,$_GET["id"],$t_faq, $_SESSION);
                          ...
                          <tr bgcolor="#D8E3EB" class="textp"> 
                            <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
                                <tr bgcolor="#D8E3EB" class="textp"> 
								  ...
								  <td width="342"><strong>Pergunta</strong></td>
                                  <td width="145">&nbsp;</td>
                                </tr>
                              </table></td>
                          </tr>
								...
								<tr class="textp" <? echo $bg;?>> 
								  ...
								  <table width="114" border="0" align="center" cellpadding="0" cellspacing="0">
									  ...
									  <tr> 
                                        ...
                                        <td width="53"><a href="javascript:verifica_deletar('delecao_bd.php?cod_faq=<? echo $resultado[0];?>')"><img src="../img/btn_apagar.jpg" width="53" height="19" border="0"></a></td>
                                      </tr>
                                    </table>
									</td>
                                </tr>
