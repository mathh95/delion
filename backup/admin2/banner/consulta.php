<?php
  ...
  include("../biblioteca/online.php");
	  ...
	  //Prepara o sql	
		if ($_REQUEST['modelo'] != '') {
			$sql = "SELECT cod_banner, nome FROM banner D  where nome like '%".$_REQUEST['modelo']."%' order by nome";
			...
			$sql = "SELECT cod_banner, nome FROM banner D order by nome";	  
	  ...
	  $p = new paginacao($db,$sql,15,10,$_GET["id"],$t_banner, $_SESSION);
				...
				<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0">
                    <tr> 
                      <td class="titulo2"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <form name="busca" action="../banner/consulta.php" enctype="multipart/form-data">
						  <tr> 
                          ...
                          <tr> 
                            <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="realce">
								...
								<tr class="textp" <? echo $bg;?>> 
                                  <td width="11%" ><a href="../banner/alteracao.php?codigo=<? echo $resultado[0];?>" class="textp"><? echo $resultado[0];?></a></td>
								  <td width="29%" ><a href="../banner/alteracao.php?codigo=<? echo $resultado[0];?>" class="textp"><? echo $resultado[1];?></a></td>
                                  <td width="13%" ><a href="../banner/alteracao.php?codigo=<? echo $resultado[0];?>" class="textp"><? echo $resultado[2];?></a></td>
                                  <td width="31%" ><a href="../banner/alteracao.php?codigo=<? echo $resultado[0];?>" class="textp"><? echo $resultado[3];?></a></td>
								  <td width="16%">
								  <table width="114" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <script src="../scripts/all.js"></script>
									  <tr> 
                                        <td width="53"><a href="../banner/alteracao.php?codigo=<? echo $resultado[0];?>"><img src="../img/btn_editar.jpg" width="53" height="19" border="0"></a></td>
                                        <td width="53"><a href="javascript:verifica_deletar('delecao_bd.php?cod_banner=<? echo $resultado[0];?>')"><img src="../img/btn_apagar.jpg" width="53" height="19" border="0"></a></td>
                                      </tr>
                                    </table>
									</td>
                                </tr>
              ...
              <tr> 
                <td height="1" align="right"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="791" height="20"> <div align="center"><a href="../banner/alteracao.php"><img src="../img/btn_cad.jpg" width="161" height="19" border="0"></a></div></td>
