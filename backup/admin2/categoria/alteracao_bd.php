   ...
   if ($_POST["cod_categoria"] == '') {
		...
		$form->atualiza("cod_categoria"); 
				...
				if ($_FILES["arquivo"]["tmp_name"]) {
					...
					$db->sql("insert into foto (codigo, tabela, foto_gd, foto_md, foto_pq) values ('$_POST[cod_categoria]', 'categoria_banner', '$caminhonovo', '$caminhonovo_med', '$caminhonovo_peq' )");
				...
				if ($_FILES["arquivo1"]["tmp_name"]) {
					...
					$src_path = $_FILES["arquivo1"]["tmp_name"];
					...
					$db->sql("insert into foto (codigo, tabela, foto_gd, foto_md, foto_pq) values ('$_POST[cod_categoria]', 'categoria_icone', '$caminhonovo', '', '' )");
