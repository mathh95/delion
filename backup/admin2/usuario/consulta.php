<?php
  ...
  include("../biblioteca/online.php");
	  ...
	  //Prepara o sql	
		if ($_REQUEST['nome'] != '') {
			$sql = "SELECT cod_usuario, nome, tipo, login FROM usuario where nome like '%".$_REQUEST['nome']."%' order by nome";
		} else {
			$sql = "SELECT cod_usuario, nome, tipo, login FROM usuario order by nome";	  
		}
	  ...
	  $p = new paginacao($db,$sql,15,10,$_GET["id"],$t_adm_usuario, $_SESSION);
                    ...
                    <tr> 
                      <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
                          <tr bgcolor="#D8E3EB" class="textp"> 
                            <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
                                <tr bgcolor="#D8E3EB" class="textp"> 
                                  <td width="123"><strong>Cod.</strong></td>
								  <td width="342"><strong>Nome</strong></td>
                                  <td width="219"><strong>Tipo</strong></td>
								  <td width="219"><strong>Login</strong></td>
                                  <td width="145">&nbsp;</td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                            <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="realce">
								...
								<tr class="textp" <? echo $bg;?>> 
                                  <td width="12%" ><a href="alteracao.php?codigo=<? echo $resultado[0];?>" class="textp"><? echo $resultado[0];?></a></td>
								  <td width="32%" ><a href="alteracao.php?codigo=<? echo $resultado[0];?>" class="textp"><? echo $resultado[1];?></a></td>
								  <td width="21%" ><a href="alteracao.php?codigo=<? echo $resultado[0];?>" class="textp"><? echo $resultado[2];?></a></td>
								  <td width="21%" ><a href="alteracao.php?codigo=<? echo $resultado[0];?>" class="textp"><? echo $resultado[3];?></a></td>
								  <td width="14%">
								  <table width="114" border="0" align="center" cellpadding="0" cellspacing="0">
                                      <script src="../scripts/all.js"></script>
									  <tr> 
                                        <td width="53"><a href="alteracao.php?codigo=<? echo $resultado[0];?>"><img src="../img/btn_editar.jpg" width="53" height="19" border="0"></a></td>
                                        <td width="53"><a href="javascript:verifica_deletar('delecao_bd.php?cod_usuario=<? echo $resultado[0];?>')"><img src="../img/btn_apagar.jpg" width="53" height="19" border="0"></a></td>
                                      </tr>
                                    </table>
									</td>
                                </tr>
              ...
              <tr> 
                <td height="1" align="right"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="791" height="20"> <div align="center"><a href="alteracao.php"><img src="../img/btn_cad.jpg" width="161" height="19" border="0"></a></div></td>
