...
--
-- Host: 127.0.0.1
-- Generation Time: 31-Jul-2019 às 16:55
...
INSERT INTO `cardapio` (`cod_cardapio`, `nome`, `preco`, `descricao`, `foto`, `categoria`, `flag_ativo`, `slug`, `prioridade`, `delivery`, `desconto`, `adicional`) VALUES
...
(1, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '2310', 'Vila Yolanda', 'ap 09'),
(2, 'Matheus Teste', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(3, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '2310', 'Vila Yolanda', 'ap 09'),
(4, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(5, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(6, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(7, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(8, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(9, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(10, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(11, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(12, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(13, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(14, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(15, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(16, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(17, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(18, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(19, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(20, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(21, 'Zé da esquina', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(22, 'teste', 45999858855, 'Avenida Felipe Wandscheer', '255', 'Vila Yolanda', 'ap 09'),
(23, 'Matheus Teste', 4599985885, 'Avenida Felipe Wandscheer', '255', '334', '344'),
(24, 'Teste', 4599985885, 'Avenida Felipe Wandscheer', '2310', 'Vila Yolanda', 'ap 09'),
(25, 'Matheus Teste', 4599988512, 'Avenida Felipe Wandscheer', '2310', 'Vila Yolanda', 'ap 09');
...
(167, 35, '2019-07-24', '11.40', 1, NULL),
(168, 35, '2019-07-24', '11.40', 3, 11);
...
INSERT INTO `pedido_wpp` (`cod_pedido_wpp`, `cod_cliente_wpp`, `data`, `valor`, `status`) VALUES
(3, 21, '2019-07-31', '17.25', 3),
(4, 22, '2019-07-31', '26.75', 1),
(5, 23, '2019-07-31', '75.00', 1),
(6, 24, '2019-07-31', '7.25', 1),
(7, 25, '2019-07-31', '7.25', 3);
...
(11, 'felipe', 'da Maia', '992ce73c8b7bdd59daa1de6ac995cad7', '', 0, 0, '[\"usuario\",\"empresa\",\"banner\",\"imagem\",\"evento\",\"categoria\",\"cardapio\",\"cliente\",\"pedido\",\"avaliacao\",\"combo\",\"adicional\"]'),
...
ALTER TABLE `cliente_wpp`
  ADD PRIMARY KEY (`cod_cliente_wpp`),
...
ALTER TABLE `item_pedido_wpp`
  ADD PRIMARY KEY (`cod_item_pedido_wpp`),
  ADD KEY `item_pedido_wpp` (`cod_produto`,`cod_pedido_wpp`) USING BTREE;
...
ALTER TABLE `pedido_wpp`
  ADD PRIMARY KEY (`cod_pedido_wpp`),
  ADD KEY `cod_cliente_wpp` (`cod_cliente_wpp`);
...
--
ALTER TABLE `cardapio`
  MODIFY `cod_cardapio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=190;
...
--
ALTER TABLE `cliente`
  MODIFY `cod_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `cliente_wpp`
--
ALTER TABLE `cliente_wpp`
  MODIFY `cod_cliente_wpp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `endereco`
  MODIFY `cod_endereco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `item_pedido`
  MODIFY `cod_item_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=344;

--
-- AUTO_INCREMENT for table `item_pedido_wpp`
--
ALTER TABLE `item_pedido_wpp`
  MODIFY `cod_item_pedido_wpp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `pedido`
--
ALTER TABLE `pedido`
  MODIFY `cod_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;

--
-- AUTO_INCREMENT for table `pedido_wpp`
--
ALTER TABLE `pedido_wpp`
  MODIFY `cod_pedido_wpp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tipo_avaliacao`
--
ALTER TABLE `tipo_avaliacao`
  MODIFY `cod_tipo_avaliacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
