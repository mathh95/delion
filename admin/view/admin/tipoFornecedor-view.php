<?php
    ...
    include_once MODELPATH."/tipoFornecedor.php";
    ...
    $tipoForn = $controle->selectId($_GET['cod']);
...
<html class="no-js" lang="pt-br">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="../../controler/alteraTipoFornecedor.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" placeholder="Tipo de fornecedor" name="tipoFornecedor" required autofocus id ="tipoFornecedor" type="text" value="<?= $formaForn->getNome();?>">
                                <input class="form-control" name="cod" id ="cod" type="hidden" value="<?= $tipoForn->getPkId();?>">
                            </div>
