...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" id="form-cadastro-usuario" method="POST" enctype="multipart/form-data" action="../../controler/businesMiniBanner.php">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <small>Foto: <span style="color:red">(Utilizar uma imagem no formato (.png) ou (.jpg). Tamanho 544[largura] x 724[altura].) </span></small>
