<?php
    ...
    $subcategoria = $controle->select($_GET['cod'], 2);
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" id="form-cadastro-usuario" method="POST" enctype="multipart/form-data" action="../../controler/alteraSubcat.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" placeholder="Nome" name="nome" required autofocus id ="nome" type="text" value="<?=  $subcategoria->getNome(); ?>"/>

                                <input class="form-control" name="cod" style="display: none;" id ="cod" type="hidden" value="<?=  $subcategoria->getPkId(); ?>"/>
                            ...
                            <img src="../../<?=  $subcategoria->getIcone(); ?>"  alt='' class='img-thumbnail img-responsive'/>
                            ...
                            <input class="form-control" name="imagem" style="display: none;" id ="imagem" type="hidden" value="../<?=  $subcategoria->getIconeAbsoluto(); ?>"/>
