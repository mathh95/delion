...
<html class="no-js" lang="pt-br">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="../../controler/alteraProdutoGer.php">
                ...
                <div class="col-md-5">
                    ...
                    <a href="gerenciarCardapio.php" class="btn btn-kionux"><i class="fa fa-arrow-left"></i> Sair sem Alterar</a>
