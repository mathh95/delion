...
$banners = $controle->selectAllMini();
	...
	if(in_array('banner', $permissao)){ 
		...
		<thead>
			...
			<tr>
	    		...
	    		<th width='16%' style='text-align: center;'>Página</th>

	    		<th width='16%' style='text-align: center;'>Link</th>

	            <th width='16%' style='text-align: center;'>Editar</th>

	            <th width='16%' style='text-align: center;'>Apagar</th>
