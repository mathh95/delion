...
if(in_array('pedidoWpp', $permissao)){
	...
	<thead>
        ...
        <tr>
            <th width='33%' style='text-align: center;'>Data Pedido</th>
    		<th width='33%' style='text-align: center;'>Hora Pedido</th>
			<th width='33%' style='text-align: center;'>Hora Impressão</th>
			<th width='33%' style='text-align: center;'>Hora Saída</th>
        </tr>
	<tbody>";
