	...
	if(in_array('evento', $permissao)){ 
		...
		<thead>
			...
			<tr>
	    		...
	    		<th width='25%' style='text-align: center;'>Nome do evento</th>
		...
		foreach ($eventos as &$evento) {
			...
			echo"<td style='text-align: center;' name='nome'>".$evento->getDsAntigo()."</td>

			 	<td style='text-align: center;' name='editar'><a style='font-size: 20px;' href='evento-view.php?cod=".$evento->getCod_evento()."'><button class='btn btn-kionux'><i class='fa fa-edit'></i>Editar</button></a></td>
