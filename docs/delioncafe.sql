...
CREATE TABLE IF NOT EXISTS `delioncafe`.`tb_adicional` (
  ...
  INDEX `fk_tb_adicional_tb_categoria1_idx` (`adi_fk_categoria` ASC) ,
  CONSTRAINT `fk_tb_adicional_tb_empresa1`
    FOREIGN KEY (`adi_fk_empresa`)
    REFERENCES `delioncafe`.`tb_empresa` (`emp_pk_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_adicional_tb_categoria1`
    FOREIGN KEY (`adi_fk_categoria`)
...
CREATE TABLE IF NOT EXISTS `delioncafe`.`tb_faixa_horario` (
  ...
  INDEX `fk_tb_faixa_horario_tb_produto1_idx` (`faho_fk_produto` ASC) ,
  CONSTRAINT `fk_tb_faixa_horario_tb_produto1`
    FOREIGN KEY (`faho_fk_produto`)
...
-- -----------------------------------------------------
-- Table `delioncafe`.`tb_historico_produto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `delioncafe`.`tb_historico_produto` ;

CREATE TABLE IF NOT EXISTS `delioncafe`.`tb_historico_produto` (
...
-- -----------------------------------------------------
-- Table `delioncafe`.`tb_gerencia_site`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `delioncafe`.`tb_gerencia_site` ;

CREATE TABLE IF NOT EXISTS `delioncafe`.`tb_gerencia_site` (
  `gesi_pk_id` INT NOT NULL AUTO_INCREMENT,
